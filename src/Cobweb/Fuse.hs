...
import Cobweb.Type.Combinators
       (All, IIndex, IReplaced, IWithout, fuseSum, fuseSumAll,
        fuseSumWith)
...
-- @
fuse ::
     (IWithout n cs cs', (n == k) ~ 'False, Functor m, All Functor cs)
